 ...
 * @date :${DATA} 15:21
 */
public class HjsApdate extends XRecyclerView.Adapter {
    private Context mContext;

    private final ArrayList<GanHuoWenZhangBean.ResultsBean> mGanHuoWenZhangBeans;

    public HjsApdate(ArrayList<GanHuoWenZhangBean.ResultsBean> ganHuoWenZhangBeans) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.item_his_item, null);
 ...
 ViewHolder viewHolder= (ViewHolder)holder;
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("img",R.mipmap.ic_web);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            mTvTxtGAndroid=view.findViewById(R.id.tv_txt_g_hjs);
            mAndTvname=view.findViewById(R.id.hjs_tvname);
            mAndTvtime=view.findViewById(R.id.hjs_tvtime);
