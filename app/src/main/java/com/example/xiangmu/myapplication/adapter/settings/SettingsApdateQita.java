 ...
 * @date :${DATA} 21:13
 */
public class SettingsApdateQita extends RecyclerView.Adapter {

    private final ArrayList<String> mChanggui;
    private final ArrayList<Integer> mIntegers;
    private final FragmentActivity mActivity;

    public SettingsApdateQita(ArrayList<String> changgui, ArrayList<Integer> integers, FragmentActivity activity) {
        mChanggui = changgui;
        mIntegers = integers;
        mActivity = activity;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mActivity).inflate(R.layout.item_settingsqita, null);
